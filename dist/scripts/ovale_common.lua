...
Define(item_potion_of_unbridled_fury 169299)
...
Define(sinister_aspirants_medallion_item 165055)
Define(sinister_aspirants_badge_item 165058)
Define(notorious_gladiators_medallion_item 165055)
Define(notorious_gladiators_badge_item 165058)
Define(notorious_aspirants_medallion_item 165055)
Define(notorious_aspirants_badge_item 165058)
Define(dread_gladiators_medallion_item 165055)
Define(dread_gladiators_badge_item 165058)
Define(dread_combatants_medallion_item 165055)
Define(dread_combatants_badge_item 165058)
Define(dread_combatants_insignia_item 165058)
Define(dread_aspirants_medallion_item 165055)
Define(dread_aspirants_badge_item 165058)
...
Define(reaping_flames_essence_1 311195)
  SpellInfo(reaping_flames_essence_1 cd=45 tag=shortcd)
Define(reaping_flames_essence_2 310690)
  SpellInfo(reaping_flames_essence_2 cd=45 tag=shortcd)
Define(reaping_flames_essence_3 311194)
  SpellInfo(reaping_flames_essence_3 cd=45 tag=shortcd)
Define(reaping_flames_essence_4 310711)
  SpellInfo(reaping_flames_essence_4 cd=45 tag=shortcd)
Define(reaping_flames_essence_5 311959)
  SpellInfo(reaping_flames_essence_5 cd=45 tag=shortcd)
Define(reaping_flames_essence_6 310705)
  SpellInfo(reaping_flames_essence_6 cd=45 tag=shortcd)
Define(reaping_flames_essence_7 310710)
  SpellInfo(reaping_flames_essence_7 cd=45 tag=shortcd)
Define(reaping_flames_essence_8 311202)
  SpellInfo(reaping_flames_essence_8 cd=45 tag=shortcd)
Define(reaping_flames_essence_9 311964)
  SpellInfo(reaping_flames_essence_9 cd=45 tag=shortcd)
Define(reaping_flames_essence_10 311947)
  SpellInfo(reaping_flames_essence_10 cd=45 tag=shortcd)
SpellList(reaping_flames_essence reaping_flames_essence_1 reaping_flames_essence_2 reaping_flames_essence_3 reaping_flames_essence_4 reaping_flames_essence_5 reaping_flames_essence_6 reaping_flames_essence_7 reaping_flames_essence_8 reaping_flames_essence_9 reaping_flames_essence_10)
