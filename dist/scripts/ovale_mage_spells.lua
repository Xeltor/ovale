...
# Rank 2: For each Arcane Charge, Arcane Barrage hits s1 additional nearby Ltarget:targets; for 44425s2 damage.
...
# Launches five waves of Arcane Missiles at the enemy over 2.5 seconds, causing a total of 5*(50 of Spell Power) Arcane damage.
  ...
  SpellRequire(arcane_missiles unusable 1=buff,evocation)
