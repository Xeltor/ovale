...
function registerBase(OvaleScripts: OvaleScriptsClass) {
	let name = "ovale_druid_base_spells";
	let desc = "[8.2] Ovale: Druid baseline spells";
...
function registerSpec1(OvaleScripts: OvaleScriptsClass) {
	let name = "ovale_druid_balance_spells";
	let desc = "[8.1] Ovale: Druid Balance spells";
	let code = `
...
function registerSpec2(OvaleScripts: OvaleScriptsClass) {
	let name = "ovale_druid_guardian_spells";
	let desc = "[8.1] Ovale: Druid Guardian spells";
	let code = `
...
function registerSpec3(OvaleScripts: OvaleScriptsClass) {
	let name = "ovale_druid_feral_spells";
	let desc = "[8.1] Ovale: Druid Feral spells";
	let code = `
Include(ovale_druid_base_spells)
...
export function registerDruidSpells(OvaleScripts: OvaleScriptsClass) {
	...
	let desc = "[8.1] Ovale: Druid spells";
	let code = `
Include(ovale_druid_base_spells)
