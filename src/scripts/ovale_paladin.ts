...
{
	const name = "sc_t24_paladin_protection"
	const desc = "[8.3] Simulationcraft: T24_Paladin_Protection"
	const code = `
...
{
	const name = "sc_t24_paladin_retribution"
	const desc = "[8.3] Simulationcraft: T24_Paladin_Retribution"
	const code = `
